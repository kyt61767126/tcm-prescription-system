...
(function(){
  ...
  tbody.addEventListener('click', async function(e){
    ...
    try{
      if(act==='approve'){
        if(!confirm('确认通过工单 '+no+'？将自动生成激活码（默认365天/2台设备）并开通云端账号。')) return;
