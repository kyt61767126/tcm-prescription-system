// ============================================================================
//  本能中医处方系统 - 云端桌面版  Electron 主进程
//
//  ★ 本文件基于 cloud_project/cloud_desktop/electron/main.js 增加：
...
//    - createMainWindow 的 dom-ready 时注入 video-recorder.js
...
function sanitizeFileName(fileName) {
    ...
    const base = String(fileName).replace(/[\\/:*?"<>|]/g, '_');
    const baseName = path.basename(base);
    return baseName || `file_${Date.now()}.webm`;
}
