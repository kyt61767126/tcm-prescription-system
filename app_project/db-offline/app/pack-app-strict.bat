...
powershell -NoProfile -Command "Write-Host '========================================' -ForegroundColor Yellow; Write-Host '  打包成功！' -ForegroundColor Yellow; Write-Host '  APK 文件: %~dp0..\惠康中医-离线机构版.apk' -ForegroundColor Yellow; Write-Host '  模式: 签名严格模式（已启用防篡改）' -ForegroundColor Yellow; Write-Host '  开始: %BUILD_START_TIME%' -ForegroundColor Yellow; Write-Host '  结束: %BUILD_END_TIME%' -ForegroundColor Yellow; Write-Host '  总耗时: %BUILD_ELAPSED%' -ForegroundColor Yellow; Write-Host '========================================' -ForegroundColor Yellow"
echo.
