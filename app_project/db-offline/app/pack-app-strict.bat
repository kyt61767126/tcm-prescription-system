...
powershell -NoProfile -Command "Write-Host '========================================' -ForegroundColor Yellow; Write-Host '  ????????' -ForegroundColor Yellow; Write-Host '  APK ???: %~dp0..\??????-?????????.apk' -ForegroundColor Yellow; Write-Host '  ??: ???????????????¡Â?????' -ForegroundColor Yellow; Write-Host '  ???: %BUILD_START_TIME%' -ForegroundColor Yellow; Write-Host '  ????: %BUILD_END_TIME%' -ForegroundColor Yellow; Write-Host '  ????: %BUILD_ELAPSED%' -ForegroundColor Yellow; Write-Host '========================================' -ForegroundColor Yellow"
echo.
