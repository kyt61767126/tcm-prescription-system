...
// ============================================================================
//  SecurityGuard — 离线 APP 安全防护（独立于 LicenseManager）
//  参考：云端 APP SecurityGuard.java，统一架构
//  差异：离线 APP 还有 LicenseManager 做 license 校验，本类仅做基础安全检测
...
public class SecurityGuard {
     ...
     * 优先使用 GET_SIGNING_CERTIFICATES（API 28+）支持 v2/v3 签名方案，
