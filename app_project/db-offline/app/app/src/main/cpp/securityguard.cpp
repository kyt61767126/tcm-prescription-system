// ============================================================================
//  securityguard.cpp — NDK 原生安全校验库（P0-NDK，2026-08-17）
//
...
//    - 离线版：com.benneng.pres.NativeGuard
//    - 云端版：com.tcm.prescription.NativeGuard
//  （JNI 符号名随包名/类名变化，故两端各保存一份；此处为离线版符号）
// ============================================================================
...
//  包名 com.benneng.pres，类名 NativeGuard（离线版）
// ----------------------------------------------------------------------------
extern "C" JNIEXPORT jboolean JNICALL
Java_com_benneng_pres_NativeGuard_nativeVerifyApkSignature(
