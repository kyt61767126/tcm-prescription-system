...
;    1) 优先安装到 D:\Program Files\tcm-prescription-personal
;    2) D 盘不存在时尝试 E:\Program Files\tcm-prescription-personal
...
!macro customInit
  ...
  IfFileExists "D:\nul" 0 tryE
    StrCpy $INSTDIR "D:\Program Files\tcm-prescription-personal"
    Goto done
  tryE:
  ; 其次 E 盘
  IfFileExists "E:\nul" 0 useDefault
    StrCpy $INSTDIR "E:\Program Files\tcm-prescription-personal"
    Goto done
  useDefault:
