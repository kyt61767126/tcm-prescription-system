...
REM   consolidation 搬回 dist 后 E2E 启动直接报 "Invalid file descriptor to ICU data" 崩溃
REM   （2026-08-29 15:25/16:32 两次打包失败根因）。此处从 node_modules\electron\dist
REM   幂等补齐（缺才复制），补齐后 icudtl.dat 仍缺失则红线中止。
