...
;    1) 优先安装到 D:\Program Files\tcm-prescription-local
;    2) D 盘不存在时尝试 E:\Program Files\tcm-prescription-local
...
!macro customInit
  ...
  IfFileExists "D:\nul" 0 tryE
    StrCpy $INSTDIR "D:\Program Files\tcm-prescription-local"
    Goto done
  tryE:
  ; 其次 E 盘
  IfFileExists "E:\nul" 0 useDefault
    StrCpy $INSTDIR "E:\Program Files\tcm-prescription-local"
    Goto done
  useDefault:
