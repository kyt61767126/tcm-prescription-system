...
Write-Host "   - app_project/db-yunduan/cloud_desktop/package.json"
Write-Host "   - app_project/db-offline/desktop_geren/package.json"
Write-Host "   - app_project/db-offline/desktop/package.json"
Write-Host ""
