...
| UI-9 | **所有版本必须包含 footer 微信号**："微信号: hktzy1688" |
...
<div class="login-container">
    ...
    <div class="footer-section">微信号: hktzy1688</div>
</div>
```

**云端桌面版需调整**：将 login-box 内的 `<div class="login-footer">微信号: hktzy1688</div>` 移除，在 login-container 末尾新增 footer-section。
